...
Public Class CrystalReportBarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aronium_Barcode_Generate.CrystalReportBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportBarcode = New CrystalReportBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
